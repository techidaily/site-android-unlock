---
title: 7 Ways to Unlock a Locked Vivo Y100A Phone
date: 2024-07-16T11:14:14.342Z
updated: 2024-07-17T11:14:14.342Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes 7 Ways to Unlock a Locked Vivo Y100A Phone
excerpt: This article describes 7 Ways to Unlock a Locked Vivo Y100A Phone
keywords: hack wifi password android,Vivo Y100A lock screen pattern,android screen lock,lock screen apps for android,android show wifi password,disable lock screen,unlock android device phone without pin,fingerprint lock app,Vivo Y100A unlock with google assistant,techeligible frp bypass,unlock screen
thumbnail: https://thmb.techidaily.com/0c4c453f95a612f76b387ff712305941e5398ae6df028882ef27bbdd6859fdde.jpg
---

## 7 Ways to Unlock a Locked Vivo Y100A Phone
...
- **Step 2.** Connect your Android device to the computer. Click "Android" > "Unlock Android Screen" and select the Vivo Y100A device brand on the list. If your device is listed in the [supported list](https://drfone.wondershare.com/reference/android-lock-screen-removal.html), you can unlock locked phone without data loss.
...
- **Step 2.** Once the interface is loaded, you can select your phone. It will locate the Vivo Y100A device automatically and provide various options.

![get into a locked phone-locate the Vivo Y100A device](https://images.wondershare.com/drfone/article/2017/10/15081758684058.jpg)
...
If you are using a Samsung device, you can also use its Find My Mobile service to unlock your device remotely. It is an excellent tool that can be accessed remotely and perform a wide range of operations that can be performed on the Vivo Y100A device. Follow these easy instructions to learn how to get into a locked Android Samsung device.
...
If your device is based on Android 4.4 and earlier versions, you may also use its native “Forgot Pattern” feature to unlock it. Though, you should have access to the Google account credentials linked to the Vivo Y100A device beforehand. To learn how to get into a locked phone with this technique, follow these steps:
...
- **Step 3.** On the next screen, you can unlock your device by providing the backup PIN of your device or sign in using the Google credentials of the account linked to the Vivo Y100A device.
...
If you are using a third-party application to lock your device, you can easily disable it by restarting your phone in safe mode. In this way, you can get rid of the respective app without causing any damage to the Vivo Y100A device. You can learn how to get into a locked Android phone by following these steps:
...
As one of the initial measures, backup the Vivo Y100A device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Vivo Y100A device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Vivo Y100A device in bootloader mode. Disconnect the Vivo Y100A  device from the PC and turn the Vivo Y100A device off completely. Press the volume down button along with the power button to switch the Vivo Y100A device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Vivo Y100A device to select Fastboot option along with pressing power button to confirm, after the Vivo Y100A device is in bootloader mode. Now, connect the Vivo Y100A device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Vivo Y100A  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Vivo Y100A device in the command prompt. So, if the Vivo Y100A device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Vivo Y100A device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Vivo Y100A , one message will appear asking if you want to unlock the Vivo Y100A device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Vivo Y100A  device will restart once and it’s done. The device is now bootloader unlocked.
...
<li><a href="https://video-capture.techidaily.com/updated-top-10-affordable-programs-for-sharing-computer-screens/"><u>[Updated] Top 10 Affordable Programs for Sharing Computer Screens</u></a></li>
