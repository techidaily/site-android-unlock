---
title: A Complete Guide To OEM Unlocking on Gionee F3 Pro
date: 2024-09-03T03:14:23.974Z
updated: 2024-09-04T03:14:23.974Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes A Complete Guide To OEM Unlocking on Gionee F3 Pro
excerpt: This article describes A Complete Guide To OEM Unlocking on Gionee F3 Pro
keywords: oem unlock missing,smart lock android,how to unlock android phone without google account,network unlock,Gionee F3 Pro best sim location trackers,Gionee F3 Pro turn off google smart lock,pattern lock,Gionee F3 Pro reset gmail password on android,unlock android phone without password,android lock screen settings,universal unlock pattern for android device
...
As one of the initial measures, backup the Gionee F3 Pro device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Gionee F3 Pro device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Gionee F3 Pro device in bootloader mode. Disconnect the Gionee F3 Pro  device from the PC and turn the Gionee F3 Pro device off completely. Press the volume down button along with the power button to switch the Gionee F3 Pro device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Gionee F3 Pro device to select Fastboot option along with pressing power button to confirm, after the Gionee F3 Pro device is in bootloader mode. Now, connect the Gionee F3 Pro device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Gionee F3 Pro  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Gionee F3 Pro device in the command prompt. So, if the Gionee F3 Pro device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Gionee F3 Pro device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Gionee F3 Pro , one message will appear asking if you want to unlock the Gionee F3 Pro device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Gionee F3 Pro  device will restart once and it’s done. The device is now bootloader unlocked.

<!-- affiliate ads begin -->
<a href="https://shop.mondly.com/affiliate.php?ACCOUNT=ATISTUDI&AFFILIATE=108875&PATH=https%3A%2F%2Fwww.mondly.com%3FAFFILIATE%3D108875%26RESOURCE%3D%2BBusiness%2B970x90%2B"><img src="https://secure.avangate.com/images/merchant/69c418c33ec2e1a4267fa9bb77fa1428/business-970x90.gif" border="0"></a>
<!-- affiliate ads end -->
## How to Lock Apps on Gionee F3 Pro to Protect Your Individual Information

If you are not a fan of having to go through the process of getting through a [pattern](https://drfone.wondershare.com/unlock/pattern-lock.html) or password every time you want to use your phone, the good news is that you don’t have to. There are really just a few Apps on your Android device that have sensitive information you don’t want others getting access to. It would really be great if you could lock those apps individually as opposed to locking the Gionee F3 Pro device as a whole.

Well, in light of helping you out, this article will address just how you can lock Apps on your device and not have to type in a code every time you want to use the Gionee F3 Pro device.
...
- You may simply want better access on your device. Locking certain apps will allow you to easily access the Gionee F3 Pro device and use it without having to remember passwords and patterns.
