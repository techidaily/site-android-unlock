---
title: Full Tutorial to Bypass Your Huawei Face Lock?
date: 2024-04-30T19:18:17.088Z
updated: 2024-05-01T19:18:17.088Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Full Tutorial to Bypass Your Huawei Face Lock?
excerpt: This article describes Full Tutorial to Bypass Your Huawei Face Lock?
keywords: Huawei Nova Y71 network unlock,best sim location trackers,how to unlock android device phone,samfw frp tool,unlock screen,reset gmail password on android,Huawei Nova Y71 pattern unlock without password,Huawei Nova Y71 pattern lock
thumbnail: https://www.lifewire.com/thmb/2mfMkf9Nh38PrId0xERnppf9iAg=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/how-to-view-instagram-without-an-account-5271416-505eeceaf0e142ed8674d2ce2244a8be.jpg
---

## Full Tutorial to Bypass Your Huawei Nova Y71 Face Lock?
...
As one of the initial measures, backup the Huawei Nova Y71 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Huawei Nova Y71 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Huawei Nova Y71 device in bootloader mode. Disconnect the Huawei Nova Y71  device from the PC and turn the Huawei Nova Y71 device off completely. Press the volume down button along with the power button to switch the Huawei Nova Y71 device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Huawei Nova Y71 device to select Fastboot option along with pressing power button to confirm, after the Huawei Nova Y71 device is in bootloader mode. Now, connect the Huawei Nova Y71 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Huawei Nova Y71  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Huawei Nova Y71 device in the command prompt. So, if the Huawei Nova Y71 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Huawei Nova Y71 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Huawei Nova Y71 , one message will appear asking if you want to unlock the Huawei Nova Y71 device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Huawei Nova Y71  device will restart once and it’s done. The device is now bootloader unlocked.
