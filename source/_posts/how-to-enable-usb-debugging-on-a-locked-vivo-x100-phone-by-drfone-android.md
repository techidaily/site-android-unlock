---
title: How To Enable USB Debugging on a Locked Vivo X100 Phone
date: 2024-07-16T12:26:09.861Z
updated: 2024-07-17T12:26:09.861Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How To Enable USB Debugging on a Locked Vivo X100 Phone
excerpt: This article describes How To Enable USB Debugging on a Locked Vivo X100 Phone
keywords: bypass android lock screen using emergency call,Vivo X100 turn off google smart lock,remove forgotten pin android device,Vivo X100 bypass knox enrollment service,hack wifi password android,android device screen lock,vnrom bypass google account verification
thumbnail: https://thmb.techidaily.com/9420d8c67dc649498f45244e433ec706e66933c2bf2f2b4b3c5585601cba7b98.jpg
---

## How To Enable USB Debugging on a Locked Vivo X100 Phone
...
<!-- affiliate ads end -->
### Guide To Unlock Your Vivo X100 With Dr.Fone – Screen Unlock (Android)
...
As one of the initial measures, backup the Vivo X100 device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Vivo X100 device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Vivo X100 device in bootloader mode. Disconnect the Vivo X100  device from the PC and turn the Vivo X100 device off completely. Press the volume down button along with the power button to switch the Vivo X100 device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Vivo X100 device to select Fastboot option along with pressing power button to confirm, after the Vivo X100 device is in bootloader mode. Now, connect the Vivo X100 device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Vivo X100  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Vivo X100 device in the command prompt. So, if the Vivo X100 device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Vivo X100 device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Vivo X100 , one message will appear asking if you want to unlock the Vivo X100 device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Vivo X100  device will restart once and it’s done. The device is now bootloader unlocked.

## How To Remove or Bypass Knox Enrollment Service On Vivo X100
...
**Knox Enrollment Service by Samsung** is a tool businesses use to automatically enroll Samsung devices into their management systems when the Vivo X100 device is connected to the internet. It’s designed for IT administrators to easily deploy, manage, and enforce policies across devices in their network, ensuring consistency and security.
...
The service allows IT administrators to pre-configure settings and apps and manage other aspects of the Vivo X100 device’s functionality. When a device is enrolled, it can be remotely controlled and monitored. The administrators can push updates, track device locations, remotely wipe data for security, and enforce specific compliance policies. This automation of device enrollment simplifies the setup process for both the IT department and the end-user.
...
- **Streamlined management.**It simplifies the Vivo X100 device management, allowing administrators to configure devices without physical access.
...
## Part 2: How To Remove Knox Enrollment Service on Your Vivo X100
...
- **Step 3:** Select the Vivo X100 device in question and click **Actions.**
- **Step 4:** Choose the **Clear Profile** option to remove all profiles from the Vivo X100 device. This action will disassociate the Vivo X100 device from any existing Knox configurations.

![knox unenroll confirmation](https://images.wondershare.com/drfone/article/2024/01/remove-knox-enrollment-service-03.jpg)

After removing the Vivo X100 device from Knox Enrollment via the admin account, you may still need to uninstall the Knox app from the Android device. This can usually be done through the Vivo X100 device’s settings. Navigate to ‘Apps’ in the settings menu, locate the Knox app, and select ‘Uninstall’ or ‘Disable’. Be aware that this option might not be available on all devices, depending on how Knox was configured.

### Rooting and Flashing a New ROM To Remove Knox Enrollment Service

For the more tech-savvy users, another method to **bypass Knox Enrollment Service** is by rooting the Vivo X100 device and flashing a new ROM. This process involves gaining root access to the Vivo X100 device’s operating system, which allows you to modify the software extensively. After rooting, you can flash a new ROM that doesn’t include the Knox software.
...
<li><a href="https://tiktok-video-recordings.techidaily.com/new-in-2024-secrets-unveiled-creating-standout-tiktok-intros-on-mac/"><u>[New] In 2024, Secrets Unveiled  Creating Standout TikTok Intros on Mac</u></a></li>
...
<li><a href="https://audio-shaping.techidaily.com/pushing-boundaries-top-15-revolutionary-songs-in-rock/"><u>Pushing Boundaries Top 15 Revolutionary Songs in Rock</u></a></li>
