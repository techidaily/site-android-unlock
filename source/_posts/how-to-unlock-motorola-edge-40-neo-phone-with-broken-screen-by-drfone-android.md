---
title: How to Unlock Motorola Edge 40 Neo Phone with Broken Screen
date: 2024-08-29T10:53:48.240Z
updated: 2024-08-30T10:53:48.241Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Motorola Edge 40 Neo Phone with Broken Screen
excerpt: This article describes How to Unlock Motorola Edge 40 Neo Phone with Broken Screen
keywords: enable usb debugging,hack wifi password android device,disable lock screen,Motorola Edge 40 Neo android device manager unlock,unlock android device phone without password,techeligible frp bypass,Motorola Edge 40 Neo pattern lock screen,universal unlock pattern for android,Motorola Edge 40 Neo fingerprint lock app
thumbnail: https://thmb.techidaily.com/b5dfde40e2a9ad5275b840b5f0fbb161aac4de7d7745911720b5a34076945390.jpg
---

## How to Unlock Motorola Edge 40 Neo Phone with Broken Screen

Seeing as the only way to control your Motorola Edge 40 Neo deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Motorola Edge 40 Neo device. Here’s how to use this bridge.
...
**Step 4:** Connect the Motorola Edge 40 Neo device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Motorola Edge 40 Neo device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Motorola Edge 40 Neo devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Motorola Edge 40 Neo device’s password lock.
...
## 6 Proven Ways to Unlock Motorola Edge 40 Neo Phone When You Forget the Password
...
## Way 1. Try Face or Fingerprint to Unlock Motorola Edge 40 Neo Phone
...
- **Step 1:** Make sure your face or fingerprint is registered correctly on the Motorola Edge 40 Neo device.
...
- **Step 3:** You can select the Motorola Edge 40 Neo device you want to unlock and tap on the "Unlock" button.
