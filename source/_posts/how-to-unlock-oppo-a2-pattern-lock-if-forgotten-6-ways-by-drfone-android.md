...
date: 2024-07-16T08:32:04.637Z
updated: 2024-07-17T08:32:04.637Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Oppo A2 Pattern Lock if Forgotten? 6 Ways
excerpt: This article describes How to Unlock Oppo A2 Pattern Lock if Forgotten? 6 Ways
keywords: Oppo A2 unlock screen,Oppo A2 unlock android phone without password,locked out of android device phone,Oppo A2 oem unlock missing,Oppo A2 fingerprint not working,Oppo A2 android pattern lock remover,pattern lock,Oppo A2 pattern lock screen,hard pattern lock,network unlock,Oppo A2 network unlock
thumbnail: https://thmb.techidaily.com/9b6e560f5ae8bf8946a31c995d6c73a4779b962b2219e90738423fb3fbbee898.jpg
---

## How to Unlock Oppo A2 Pattern Lock if Forgotten? 6 Ways
...
- **Step 4.** You will be notified when the process is completed. Simply disconnect your Oppo A2 and access it without any pattern lock.
...
![select the Oppo A2 device](https://images.wondershare.com/drfone/article/2017/09/15057372918464.jpg)
...
- **Step 4.** Once the Oppo A2 device would be restarted in Safe Mode, the third-party lock screen would be disabled automatically.

![android safe mode](https://images.wondershare.com/drfone/article/2017/09/15057373753769.jpg)

- **Step 5.** Later, you can go to the Oppo A2 device’s Settings > Apps and remove the third-party app as well. In this way, you would be able to learn how to unlock pattern lock for any other app.
...
## How To Track IMEI Number Of Oppo A2 Through Google Earth?
...
## Part 1: How To Track Your Oppo A2 on Google Earth
...
- **No Need for Special Apps.**Unlike many other tracking methods, IMEI tracking doesn't require any special apps or software to be installed on the Oppo A2 device you want to track. It relies on the unique IMEI number of the Oppo A2 device.
...
- **Internet and Network Dependency.**IMEI tracking depends on the Oppo A2 device being connected to the internet or a mobile network. If the Oppo A2 device is turned off, in airplane mode, or disconnected, tracking may be impossible.
...
- **Step 8:** The next screen displays the unlocking iOS device's progress bar. Keep in mind that the Oppo A2 device must be connected at all times; otherwise, it will brick.
...
<!-- affiliate ads end -->
## How To Unlock Oppo A2 Phone Without Password?
...
You need to log into the Google account that is associated with the Oppo A2 device, then do the following:
...
- You must enter the Gmail account that is associated with the Oppo A2 device here before selecting "Next."
...
Using your Google account is a superb method for finding the Oppo A2 device when lost or stolen.
...
To bypass the Android lock screen, all you need to do is sign into the Oppo A2 device's associated Google account and then follow these steps:
...
- After choosing the Oppo A2 device, select one of the three options, "lock," from the list.
- There will be a new pop-up window that you can use to change the Oppo A2 device password. Additionally, you can choose to add a phone number or recovery email.
...
- Here, you must use a USB cable to connect your Oppo A2 to the computer
...
When your phone is locked, you may access the recovery menu of your phone using its physical keys and choose to hard reset the Oppo A2 device. Here's how to restore a locked phone to factory settings.
...
- Press the Power button on your phone for around 30 seconds, or until the Oppo A2 device restarts.
...
<!-- affiliate ads end -->
![choose the Oppo A2 device model](https://images.wondershare.com/drfone/guide/screen-unlock-any-android-device-2.png)
