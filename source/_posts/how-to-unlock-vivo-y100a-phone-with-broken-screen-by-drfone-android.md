---
title: How to Unlock Vivo Y100A Phone with Broken Screen
date: 2024-07-16T11:15:06.036Z
updated: 2024-07-17T11:15:06.036Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Vivo Y100A Phone with Broken Screen
excerpt: This article describes How to Unlock Vivo Y100A Phone with Broken Screen
keywords: lock screen wallpaper on android device,unlock android device phone without password,oem unlock missing,Vivo Y100A unlock apps for android,bypass android device face lock,easy pattern lock,Vivo Y100A forgot android password,how to reset voicemail password,how to unlock android device phone,Vivo Y100A easy pattern lock,Vivo Y100A password unlock tool,smart lock android device
thumbnail: https://thmb.techidaily.com/3dd5b17c533ab88ed9cc0f3b00c7a2aa3b7c864b4f9c2a1611133710cbbaabe1.jpg
---

## How to Unlock Vivo Y100A Phone with Broken Screen

Seeing as the only way to control your Vivo Y100A deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Vivo Y100A device. Here’s how to use this bridge.
...
**Step 4:** Connect the Vivo Y100A device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Vivo Y100A device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Vivo Y100A devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Vivo Y100A device’s password lock.
...
- **Step 2.** Then you would need to insert the SD card into your locked phone and then restart the Vivo Y100A device in recovery mode.
...
_**Note**: Sometimes, the Vivo Y100A device may ask for a pattern or password. You just need to put in any random pattern/password then it will get unlocked._
