---
title: In 2024, Delete Gmail Account With/Without Password On Huawei Nova Y91
date: 2024-08-17T00:41:27.213Z
updated: 2024-08-18T00:41:27.213Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Delete Gmail Account With/Without Password On Huawei Nova Y91
excerpt: This article describes Delete Gmail Account With/Without Password On Huawei Nova Y91
keywords: unlock android device phone without password,hack wifi password android device,top 10 frp bypass tools,Huawei Nova Y91 password unlock tool,Huawei Nova Y91 network unlock,android emergency call bypass,reset gmail password on android device,swipe screen to unlock,Huawei Nova Y91 unlock with google assistant
thumbnail: https://thmb.techidaily.com/c44b3c2a949ed90a1a74d6b8f5c0458cbf8a943f8d64ce0fc757b91844bd2888.jpg
---

## Delete Gmail Account With/Without Password On Huawei Nova Y91
...
What if you've [forgotten the password](https://drfone.wondershare.com/app-password/find-gmail-password.html) to your smartphone device, and you have to **delete your Gmail account permanently?** In such cases, you are left with the option of accessing the Huawei Nova Y91 device’s Recovery Mode and factory resetting the Huawei Nova Y91 device, where possible. To know how it is done flawlessly, look through the steps provided next:

### Android Devices

- **Step 1.** Those owning an Android device need to put it in Recovery Mode first. For that, use the combination of the "Power" and "Volume" keys to put the Huawei Nova Y91 device in Recovery Mode.
...
This article has specifically provided you with some important details on **how to delete a Gmail account** with ease. The article explains everything from the methods of deleting it from the computer to removing it from the Huawei Nova Y91 device. Furthermore, it also serves as a guidance for those who have forgotten their device passwords. For that, they've provided an insight into Wondershare Dr.Fone – Screen Unlock and its unique functions.

<!-- affiliate ads begin -->
<a href="https://secure.2checkout.com/order/checkout.php?PRODS=4712430&QTY=1&AFFILIATE=108875&CART=1"><img src="https://secure.avangate.com/images/merchant/c404a5adbf90e09631678b13b05d9d7a/products/dlnow_256.png" border="0">DLNow Video Downloader</a>
<!-- affiliate ads end -->
## How To Unlock Huawei Nova Y91 Phone Without Password?
...
You need to log into the Google account that is associated with the Huawei Nova Y91 device, then do the following:
...
- You must enter the Gmail account that is associated with the Huawei Nova Y91 device here before selecting "Next."
...
Using your Google account is a superb method for finding the Huawei Nova Y91 device when lost or stolen.
...
To bypass the Android lock screen, all you need to do is sign into the Huawei Nova Y91 device's associated Google account and then follow these steps:
...
- After choosing the Huawei Nova Y91 device, select one of the three options, "lock," from the list.
- There will be a new pop-up window that you can use to change the Huawei Nova Y91 device password. Additionally, you can choose to add a phone number or recovery email.
...
- Here, you must use a USB cable to connect your Huawei Nova Y91 to the computer
...
When your phone is locked, you may access the recovery menu of your phone using its physical keys and choose to hard reset the Huawei Nova Y91 device. Here's how to restore a locked phone to factory settings.
...
- Press the Power button on your phone for around 30 seconds, or until the Huawei Nova Y91 device restarts.
...
![choose the Huawei Nova Y91 device model](https://images.wondershare.com/drfone/guide/screen-unlock-any-android-device-2.png)
<!-- affiliate ads begin -->
