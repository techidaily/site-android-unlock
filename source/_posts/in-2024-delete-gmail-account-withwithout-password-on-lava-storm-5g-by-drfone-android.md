---
title: In 2024, Delete Gmail Account With/Without Password On Lava Storm 5G
date: 2024-08-24T09:35:32.199Z
updated: 2024-08-25T09:35:32.199Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Delete Gmail Account With/Without Password On Lava Storm 5G
excerpt: This article describes Delete Gmail Account With/Without Password On Lava Storm 5G
keywords: Lava Storm 5G unlock with google assistant,vnrom bypass google account verification,how to reset voicemail password,universal unlock pattern for android device,unlock with google assistant,Lava Storm 5G android screen lock,turn off google smart lock
...
As one of the initial measures, backup the Lava Storm 5G device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
<!-- affiliate ads end -->
After selecting the Lava Storm 5G device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Lava Storm 5G device in bootloader mode. Disconnect the Lava Storm 5G  device from the PC and turn the Lava Storm 5G device off completely. Press the volume down button along with the power button to switch the Lava Storm 5G device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Lava Storm 5G device to select Fastboot option along with pressing power button to confirm, after the Lava Storm 5G device is in bootloader mode. Now, connect the Lava Storm 5G device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Lava Storm 5G  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Lava Storm 5G device in the command prompt. So, if the Lava Storm 5G device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Lava Storm 5G device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Lava Storm 5G , one message will appear asking if you want to unlock the Lava Storm 5G device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Lava Storm 5G  device will restart once and it’s done. The device is now bootloader unlocked.
...
If your Lava device runs on Android 4.4 and previous versions, then you can easily move past the password/pattern lock without any trouble. The provision is not available on devices, which run on newer versions of Android. Nevertheless, for all the Lava Storm 5G devices running on older versions than Android 4.4, this is undoubtedly the easiest way to set a new passcode. Follow these steps to learn how to unlock your Lava phone if you forgot your password using your Google credentials.
