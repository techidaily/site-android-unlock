---
title: In 2024, How To Fix OEM Unlock Missing on Sony Xperia 10 V?
date: 2024-08-17T00:43:58.751Z
updated: 2024-08-18T00:43:58.751Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: forgot pattern lock,universal unlock pattern for android,unlock apps for android device,unlock android phone without pin,android device emergency call bypass,pattern unlock,Sony Xperia 10 V reset locked android phone,bypass android face lock
...
## How To Unlock Sony Xperia 10 V Phone Without Password?
...
You need to log into the Google account that is associated with the Sony Xperia 10 V device, then do the following:
...
- You must enter the Gmail account that is associated with the Sony Xperia 10 V device here before selecting "Next."
...
Using your Google account is a superb method for finding the Sony Xperia 10 V device when lost or stolen.
...
To bypass the Android lock screen, all you need to do is sign into the Sony Xperia 10 V device's associated Google account and then follow these steps:
...
- After choosing the Sony Xperia 10 V device, select one of the three options, "lock," from the list.
- There will be a new pop-up window that you can use to change the Sony Xperia 10 V device password. Additionally, you can choose to add a phone number or recovery email.
...
- Here, you must use a USB cable to connect your Sony Xperia 10 V to the computer
...
When your phone is locked, you may access the recovery menu of your phone using its physical keys and choose to hard reset the Sony Xperia 10 V device. Here's how to restore a locked phone to factory settings.
...
- Press the Power button on your phone for around 30 seconds, or until the Sony Xperia 10 V device restarts.
...
![choose the Sony Xperia 10 V device model](https://images.wondershare.com/drfone/guide/screen-unlock-any-android-device-2.png)
<!-- affiliate ads begin -->
...
## Rootjunky APK To Bypass Google FRP Lock For Sony Xperia 10 V 
...
FRP automatically activates when you add a Google account to your Android phone. It links the Sony Xperia 10 V device to your account, making it the “trusted owner.” Once activated, FRP becomes embedded in the phone’s system.
