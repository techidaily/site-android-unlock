---
title: In 2024, How to Unlock Lava Yuva 3 Pro Phone with Broken Screen
date: 2024-08-24T09:37:03.610Z
updated: 2024-08-25T09:37:03.610Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Lava Yuva 3 Pro Phone with Broken Screen
excerpt: This article describes How to Unlock Lava Yuva 3 Pro Phone with Broken Screen
keywords: bypass knox enrollment service,how to unlock android device phone,Lava Yuva 3 Pro reset locked android phone,unlock apps for android,how to reset voicemail password,unlock with google assistant,fingerprint lock for android,fingerprint lock app,bypass android lock screen using emergency call,android show wifi password,locked out of android phone
thumbnail: https://thmb.techidaily.com/36cb4ddf3fc78c71836e11f4a803426f35040ec4e34c37b6c57cca04ad1d4891.jpg
---

## How to Unlock Lava Yuva 3 Pro Phone with Broken Screen

Seeing as the only way to control your Lava Yuva 3 Pro deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Lava Yuva 3 Pro device. Here’s how to use this bridge.
...
**Step 4:** Connect the Lava Yuva 3 Pro device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Lava Yuva 3 Pro device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
<!-- affiliate ads end -->
**Step 2:** As soon as the Lava Yuva 3 Pro devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Lava Yuva 3 Pro device’s password lock.
