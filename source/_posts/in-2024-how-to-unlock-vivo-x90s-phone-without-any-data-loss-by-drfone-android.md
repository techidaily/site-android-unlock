---
title: In 2024, How to Unlock Vivo X90S Phone without Any Data Loss
date: 2024-07-16T11:50:30.931Z
updated: 2024-07-17T11:50:30.931Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Vivo X90S Phone without Any Data Loss
excerpt: This article describes How to Unlock Vivo X90S Phone without Any Data Loss
keywords: Vivo X90S bypass android lock screen using emergency call,unlock android device phone without pin,Vivo X90S turn off google smart lock,reset gmail password on android device,Vivo X90S android screen lock,Vivo X90S enable usb debugging,unlock with google assistant,unlock apps for android
...
As one of the initial measures, backup the Vivo X90S device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Vivo X90S device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Vivo X90S device in bootloader mode. Disconnect the Vivo X90S  device from the PC and turn the Vivo X90S device off completely. Press the volume down button along with the power button to switch the Vivo X90S device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Vivo X90S device to select Fastboot option along with pressing power button to confirm, after the Vivo X90S device is in bootloader mode. Now, connect the Vivo X90S device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Vivo X90S  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Vivo X90S device in the command prompt. So, if the Vivo X90S device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Vivo X90S device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Vivo X90S , one message will appear asking if you want to unlock the Vivo X90S device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Vivo X90S  device will restart once and it’s done. The device is now bootloader unlocked.

## Lock Your Vivo X90S Phone in Style: The Top 5 Gesture Lock Screen Apps
