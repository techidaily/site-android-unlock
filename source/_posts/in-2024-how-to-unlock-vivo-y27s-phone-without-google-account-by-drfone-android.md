---
title: In 2024, How to Unlock Vivo Y27s Phone without Google Account?
date: 2024-07-16T12:24:57.498Z
updated: 2024-07-17T12:24:57.498Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Vivo Y27s Phone without Google Account?
excerpt: This article describes How to Unlock Vivo Y27s Phone without Google Account?
keywords: easy pattern lock,how to unlock android phone without google account,Vivo Y27s remove forgotten pin android,delete gmail account with without password,fingerprint lock app,Vivo Y27s unlock android phone password without factory reset
thumbnail: https://thmb.techidaily.com/485101ae8f555e145174a15eda6071c25617b2b00c96089d339b8e4537366b75.jpg
---

## How to Unlock Vivo Y27s Phone without Google Account?
...
3\. A list of all of the Vivo Y27s devices registered to this Android account will pop up. Select the Vivo Y27s device in question from this list.
...
Now connect your Android phone connected with the PC, and select the Vivo Y27s device brand from the list.
...
As one of the initial measures, backup the Vivo Y27s device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Vivo Y27s device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Vivo Y27s device in bootloader mode. Disconnect the Vivo Y27s  device from the PC and turn the Vivo Y27s device off completely. Press the volume down button along with the power button to switch the Vivo Y27s device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Vivo Y27s device to select Fastboot option along with pressing power button to confirm, after the Vivo Y27s device is in bootloader mode. Now, connect the Vivo Y27s device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Vivo Y27s  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Vivo Y27s device in the command prompt. So, if the Vivo Y27s device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Vivo Y27s device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Vivo Y27s , one message will appear asking if you want to unlock the Vivo Y27s device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Vivo Y27s  device will restart once and it’s done. The device is now bootloader unlocked.
