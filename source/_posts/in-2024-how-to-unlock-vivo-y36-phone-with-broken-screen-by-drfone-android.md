---
title: In 2024, How to Unlock Vivo Y36 Phone with Broken Screen
date: 2024-07-16T11:48:02.273Z
updated: 2024-07-17T11:48:02.273Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes How to Unlock Vivo Y36 Phone with Broken Screen
excerpt: This article describes How to Unlock Vivo Y36 Phone with Broken Screen
keywords: reset locked android phone,turn off google smart lock,how to use oem unlocking,universal unlock pattern for android device,gusture lock screen,reset gmail password on android device,disable lock screen
thumbnail: https://thmb.techidaily.com/ac86b0aa564fee722115c20830e542db073002bfbdd584be2acd66419238b8a6.png
---

## How to Unlock Vivo Y36 Phone with Broken Screen

Seeing as the only way to control your Vivo Y36 deviceis the touch screen, a broken device can cause you a lot of worries. Most people think that there is no way to get their device to work again let alone be able to unlock it if [the screen is broken or cracked](https://www.wondershare.com/android/access-android-phone-with-broken-screen.html). It is, however, important to find a way to unlock the broken device so that you can gain access to your data and create a backup to restore to a new device.
...
ADB creates a bridge between the PC and your device which can then be used to unlock the Vivo Y36 device. Here’s how to use this bridge.
...
**Step 4:** Connect the Vivo Y36 device to your PC using USB cables. Enter the command “ ADB _device_” (without quotation marks). If your phone is recognized, you will see numbers in the Command Prompt message.
...
This is a great solution if you don’t have USB debugging enabled on your device. You will need your device, an OTG adapter and a USB mouse. It involves connecting the Vivo Y36 device to the USB mouse using the OTG adapter. Check if your device can be connected to a USB mouse. You can find an OTG adapter online, they are relatively inexpensive and very useful.
...
**Step 2:** As soon as the Vivo Y36 devices are connected, you will be able to see a pointer on your screen. You can then use the pointer to unlock the pattern or enter the Vivo Y36 device’s password lock.
...
## How to Remove Forgotten PIN Of Your Vivo Y36
...
4. Once more, select "Erase." This will reset the Vivo Y36 device and get rid of the forgot pattern lock.
...
1. Will Dr.Fone - Screen Unlock Do Harm To My Vivo Y36?
