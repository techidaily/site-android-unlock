---
title: In 2024, Mastering Lock Screen Settings How to Enable and Disable on Vivo Y17s
date: 2024-07-16T12:12:01.690Z
updated: 2024-07-17T12:12:01.690Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Mastering Lock Screen Settings How to Enable and Disable on Vivo Y17s
excerpt: This article describes Mastering Lock Screen Settings How to Enable and Disable on Vivo Y17s
keywords: remove screen lock pin on android device,Vivo Y17s password cracker tools,unlock android device phone password without factory reset,Vivo Y17s easy pattern lock,android device show wifi password,pattern unlock,enable usb debugging,Vivo Y17s android lock screen settings
thumbnail: https://thmb.techidaily.com/078ec5c6b19df307c3d053f03815c7d21ecece8ed3226ebe1d118a70909568e6.jpg
---

## Mastering Lock Screen Settings: How to Enable and Disable on Vivo Y17s
...
As one of the initial measures, backup the Vivo Y17s device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Vivo Y17s device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Vivo Y17s device in bootloader mode. Disconnect the Vivo Y17s  device from the PC and turn the Vivo Y17s device off completely. Press the volume down button along with the power button to switch the Vivo Y17s device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Vivo Y17s device to select Fastboot option along with pressing power button to confirm, after the Vivo Y17s device is in bootloader mode. Now, connect the Vivo Y17s device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Vivo Y17s  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Vivo Y17s device in the command prompt. So, if the Vivo Y17s device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Vivo Y17s device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Vivo Y17s , one message will appear asking if you want to unlock the Vivo Y17s device bootloader.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822585759420.jpg)

Use volume keys to select and power button to confirm. Once this is done, the Vivo Y17s  device will restart once and it’s done. The device is now bootloader unlocked.
