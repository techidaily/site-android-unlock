---
title: In 2024, Top Apps and Online Tools To Track Lava Agni 2 5G Phone With/Without IMEI Number
date: 2024-11-14T04:07:27.973Z
updated: 2024-11-16T13:06:24.881Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Top Apps and Online Tools To Track Lava Agni 2 5G Phone With/Without IMEI Number
excerpt: This article describes Top Apps and Online Tools To Track Lava Agni 2 5G Phone With/Without IMEI Number
keywords: turn off google smart lock,bypass lock screen password,Lava Agni 2 5G how to change lock screen password,android device password reset,top 10 frp bypass tools,Lava Agni 2 5G unlock android phone password without factory reset,lock apps with fingerprint,lock screen wallpaper on android,Lava Agni 2 5G how to reset a phone that is locked,Lava Agni 2 5G how to unlock android phone,Lava Agni 2 5G oem unlock missing,how to remove previously synced google account from android
...
## Tips and Tricks for Setting Up your Lava Agni 2 5G Phone Pattern Lock
...
**Step 4.** To reset the **lock screen pattern**, you must give the correct details of the Google ID previously logged into the Lava Agni 2 5G device.
...
As one of the initial measures, backup the Lava Agni 2 5G device completely as bootloader unlocking process will wipe all the data off. So, backup all the data like photos, contacts, multimedia files, documents, etc.
...
After selecting the Lava Agni 2 5G device, click on “Begin Unlock Bootloader”, and then confirm all the dialogue boxes which come your way on screen.

Step 4: Now, you will be presented with four steps to put the Lava Agni 2 5G device in bootloader mode. Disconnect the Lava Agni 2 5G  device from the PC and turn the Lava Agni 2 5G device off completely. Press the volume down button along with the power button to switch the Lava Agni 2 5G device on in bootloader mode.

![htc unlock bootloader](https://images.wondershare.com/drfone/article/2016/12/14822589729198.jpg)

Step 5: Use the volume keys of the Lava Agni 2 5G device to select Fastboot option along with pressing power button to confirm, after the Lava Agni 2 5G device is in bootloader mode. Now, connect the Lava Agni 2 5G device to the computer using a USB cable.
...
Step 7: In the command prompt window, type “fastboot devices” and press enter. Lava Agni 2 5G  will show up in the command prompt.

Note: The drivers have to be installed correctly to see the Lava Agni 2 5G device in the command prompt. So, if the Lava Agni 2 5G device does not show up, reinstall HTC Sync Manager and try again after restarting the computer.

Step 8: On HTC Dev’s website third page, click on “proceed to Step 9”. Follow the steps listed and then click on submit. The unlock token code for the Lava Agni 2 5G device will be mailed by HTC. Download the token and name it “Unlock\_code.bin” and place the token in the fastboot folder.

Step 9: Now, in the command prompt window, type the following:

fastboot flash unlocktoken Unlock\_code.bin

Step 10: On the Lava Agni 2 5G , one message will appear asking if you want to unlock the Lava Agni 2 5G device bootloader.
...
Use volume keys to select and power button to confirm. Once this is done, the Lava Agni 2 5G  device will restart once and it’s done. The device is now bootloader unlocked.
