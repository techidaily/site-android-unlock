---
title: Unlocking the Power of Smart Lock A Beginners Guide for Vivo Y17s Users
date: 2024-09-16T17:13:58.738Z
updated: 2024-09-19T20:50:18.659Z
tags: 
  - unlock
  - remove screen lock
categories:
  - android
description: This article describes Unlocking the Power of Smart Lock A Beginners Guide for Vivo Y17s Users
excerpt: This article describes Unlocking the Power of Smart Lock A Beginners Guide for Vivo Y17s Users
keywords: Vivo Y17s forgot pattern lock,Vivo Y17s unlock android phone without pin,android device lock screen settings,easy pattern lock,Vivo Y17s delete gmail account with without password,how to unlock android device phone,how to reset a phone that is locked,unlock apps for android device,Vivo Y17s unlock screen
thumbnail: https://thmb.techidaily.com/8383b1955265d208bd65863f99fa93e0506dbf01fc1cf31d37490fb679a3c33d.png
---

## Unlocking the Power of Smart Lock: A Beginner's Guide for Vivo Y17s Users
...
Android Lollipop added a feature called Smart Lock, and the feature was devised as a smart tool to prevent the Android phone from locking once it was initially unlocked. In other words, the feature overrides an Android phone's Lock Screen feature, thereby saving users the need to enter passwords every time the Vivo Y17s device locks.
...
Since you have already paired Bluetooth, it will ask you to choose the Vivo Y17s device from the list.
...
The feature recognizes your face and then unlocks the Vivo Y17s device. Once you set up the Vivo Y17s device to recognize your face as a trusted face, it will unlock the Vivo Y17s device as soon as it recognizes you.

![smart lock android](https://images.wondershare.com/drfone/others/14555208588486.jpg)

PRECAUTION:  At best, this can be the first level of security, as one who resembles you to some extent can unlock the Vivo Y17s device. Photographs are not stored in the system. The device does hold necessary data to recognize your face, and the security level is determined by how good the Vivo Y17s device is configured. The data is not accessed by any app or loaded onto a Google server for backup.
...
The device begins to gather data about your face. The trusted face icon appears. As a backup, in case Smart Lock does not recognize your face, use the manual system by applying the PIN or password to unlock the Vivo Y17s device.
...
## How to Unlock Vivo Y17s Phone without Google Account?
...
3\. A list of all of the Vivo Y17s devices registered to this Android account will pop up. Select the Vivo Y17s device in question from this list.
...
Now connect your Android phone connected with the PC, and select the Vivo Y17s device brand from the list.
